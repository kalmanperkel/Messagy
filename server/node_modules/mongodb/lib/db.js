 ...
 * @param {string} [options.viewOn=null] The name of the source collection or templates from which to create the templates. The name is not the full namespace of the collection or templates; i.e. does not include the database name and implies the same database as the templates to create on MongoDB 3.4 or higher.
 * @param {array} [options.pipeline=null] An array that consists of the aggregation pipeline stage. create creates the templates by applying the specified pipeline to the viewOn collection or templates on MongoDB 3.4 or higher.
